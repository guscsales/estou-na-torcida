...
export default function PrivatePolicy() {
  return (
    <Container className="flex flex-col gap-3 mt-6">
      ...
      <Text as="p">
        A sua privacidade é importante para nós. É política do Estou Na Torcida
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site Estou Na Torcida, e outros sites que possuímos
        e operamos.
      </Text>
      <Text as="p">
      ...
      <ul>
        ...
        <li>
          <Text as="p">
            ...
            (softwares) do Estou Na Torcida, de seus fornecedores ou terceiros,
      ...
      <Text as="p" className="font-bold">
        Esta política é efetiva a partir de 2 Novembro de 2022 às 10:00 horário
        de Brasília.
      </Text>
    </Container>
  );
